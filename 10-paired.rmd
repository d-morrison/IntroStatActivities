...
The remaining questions cover theory based methods for testing a single categorical variable.  Use section ????? in the textbook and the OnePropTheory video to complete the following questions.
