...
10.  Using the linear model `R` output, report the p-value for the test of significance for slope.
...
15. Does the p-value agree with the 95\% confidence interval?  What does each tell you about the null hypothesis?
