...
5. Are the conditions met to use the $t$-distribution to approximate the sampling distribution of our test statistic?
...
Using the provided `R` markdown file, enter the response variable into the linear model function for yy and the explanatory variable for xx to get the linear model output.

```{r, echo=TRUE, eval =FALSE}
lm.hand <- lm(yy~xx, data=hands) #lm(response~explanatory)
