...
IPEDS <- IPEDS_Data_2018 #Creates the object IPEDS 
IPEDS <- IPEDS %>%
...
To show the effect of outliers on the measures of center and spread, the smallest values of retention rate in the data set were increased by 30%. **Highlight and run lines 31--38**.  
...
IPEDS %>%  # Data set piped into...
  summarise(favstats(Retention~Control)) # Summary statistics for retention rates
```
