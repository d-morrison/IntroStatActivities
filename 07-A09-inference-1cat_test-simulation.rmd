## Week 7 - Activity 9:  Helperer-Hinderer --- Testing
...
3. Write out in context the statistic we will calculate to summarize the data.

\vspace{0.5in}

#### Ask a research question {-}

4. Identify the research question for this study.
...
6.  Using the output above, calculate the appropriate summary statistic to represent the research question.  Use appropriate notation.

\vspace{0.5in}

7.  What type of plot should be used to represent these data? Sketch this plot.
...
9.  Using the parameter of interest in question 8, write out the null hypothesis in words.  That is, what do we assume to be true about the parameter of interest when we perform our simulation?
...
10. Write the null hypothesis in notation using the null value of 0.5 in place of $\pi_0$ in the equation given above.

\vspace{0.5in}

11.  Why are we assuming a null value of 0.5 in this study? **work on rephrasing**
...
12.  Based on the research question from question 4, are we testing that the parameter is greater than 0.5, less than 0.5 or different than 0.5? 
...
Let's think about how to use red and blue cards (**or write on the cards?**) to create one simulation of 16 infants under the assumption the null hypothesis is true.  Suppose blue cards represent infants who choose the helper and red cards represent infants who choose the hinderer.
...
18.  Create one simulation using the cards provided.  Report your results to your instructor.  Sketch the distribution of simulated results created by your class below.
...
22. Circle the observed statistic (value from question 6) on the distribution you drew in question 20.  Where does this statistic fall in the null distribution: Is it near the center of the distribution (near 0.5) or in one of the tails of the distribution?  

\vspace{1in}

23. Is the observed statistic likely to happen or unlikely to happen if the true proportion of infants who choose the helper is 0.5?  Explain your answer using the plot.

\vspace{1in}

24.  Using the simulation, what is the proportion of simulated samples that generated a sample proportion at the observed statistic or greater, if the true proportion of infants who choose the helper is 0.5? *Hint*: Look under the simulation.

\vspace{1in}

The value in question 24 is the **p-value**.  The smaller the p-value, the more evidence we have against the null hypothesis. Explain why this makes sense?

\vspace{0.5in}

25. Using the following guidelines for the strength of evidence, how much evidence do the data provide against the null hypothesis? (Circle one of the five descriptions.)
...
28.  Write a paragraph summarizing the results as if you were writing a press release.  Be sure to describe:
