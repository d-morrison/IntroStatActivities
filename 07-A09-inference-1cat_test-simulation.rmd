...
12.  Based on the research question from question 5, are we testing that the parameter is greater than 0.5, less than 0.5 or different than 0.5? 
...
Let's think about how to use red and blue cards to create one simulation of 16 infants under the assumption the null hypothesis is true.  Suppose blue cards represent infants who choose the helper and red cards represent infants who choose the hinderer.
