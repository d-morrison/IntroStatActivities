...
| `Before_PuzzleCube` | Time to complete puzzle cube (in minutes) before listening to assigned music |
| `After_PuzzleCube` | Time to complete puzzle cube (in minutes) after listening to assigned music |
| `Diff_PuzzleCube` | Difference in time to complete puzzle cube (in minutes) for Before - After listening to assigned music |
| `Education_Level` | Highest level of education completed (note: there is some missing data depicted by NA) |
