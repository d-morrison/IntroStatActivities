...
\section{Stat 216 Intro and Syllabus Fall 2016}

\begin{center}
  {\bf People}
\end{center}
\begin{itemize}
\item Your Instructor: (Write contact info here) \vspace{2.5cm}
\item Student Success Coordinator:\\
      Until October 15th:  Melinda Yager\\
     email: melinda.yager@montana.edu\hfill Office: Wilson 2-259 \hfill
     406-994-5344\\
      After October 15th: Jade Schmidt\\
     email: jade.schmidt2@montana.edu\hfill Office: Wilson 2-263 \hfill
     406-994-4606
   \item Course Supervisor: Dr. Hancock\\
     email: stacey.hancock@montana.edu \hfill  Office: Wilson 2-195 \hfill
     406-994-5350
\end{itemize}
...
\begin{itemize}
\item {\bf D2Boxes: 15\%}   %%{\bf Assignments: 25\%} %
...
\item {\bf %%(summer) Midterm Exam \  30\%}
  Common Hour Exam I: Tuesday, September 27, 2016, 6:00 pm: \hfill 20\%}\\  
  Taken individually, not in groups. You may bring one handwritten
  page of notes.  

 \item {\bf Common Hour Exam II: Thursday November 3, 2016, 6:00 pm: \hfill    20\%}\\
   Taken individually, not in groups. You may bring a one handwritten sheet
   of notes. 

\item {\bf Final Exam: Wednesday, December 14,  2016: \hfill 25\%}.\\
             % summer:  \  35\%}.\\
...
\end{list}
 ...
 September 19, 2016 is the last day to withdraw without a ``W'' grade.
...
\item Complete {\bf D2Quiz 1} on D2L by 11 pm Sept 1.  Note: you can
