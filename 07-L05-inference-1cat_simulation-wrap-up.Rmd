## Week 7 - Lab 5:  Comic Book Characters
...
one_proportion_test(probability_success = 0.25, # Null hypothesis value
          ...
          as_extreme_as = 25/52, # Observed statistic
...
13.  Go to this website, [http://www.rossmanchance.com/ISIapplets.html](http://www.rossmanchance.com/ISIapplets.html) and choose 'Simulating Confidence Intervals'.  In the input on the left-hand side of the screen enter 0.1 for $\pi$, 500 for $n$, and 100 for 'Intervals'.  Click 'sample'.
\vspace{1mm}
