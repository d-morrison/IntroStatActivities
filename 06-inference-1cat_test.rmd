...
```{r simpleNormal, fig.cap="A standard normal curve.", warning=FALSE, fig.width=8}
X <- seq(-5,5,0.01)
Y <- dnorm(X)
...
4.  Using the 68-95-99.7 rule in Section 5.2.5 to guide you, fill in values on the $x$-axis of the standard normal distribution displayed in Figure \@ref(simpleNormal), and mark on the value of the standardized statistic calculated in question 3.
