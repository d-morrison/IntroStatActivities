## Week 4 - Activity 6:  IMDb Movie Reviews - Displaying two variables
...
The box plot of movie budgets (in millions) by content rating is plotted using the code below.  Enter the variable `budget_mil` for yy and the variable `content_rating` for xx at line 14, highlight and run code lines 1-18. This plot helps to compare the budget for different levels of content rating.
...
```{r}
Movies2016_Sub <- read.csv("data/Movies2016_Sub.csv")
