...
Diving_Penguins %>% # Pipe data set into...
ggplot(aes(x = Dive.Heart.Rate, y = Duration.min.))+  # Specify variables
...
lm.diving <- lm(Duration.min.~Dive.Heart.Rate, data=Diving_Penguins) # lm(response~explanatory)
