...
Using the provided R script file, enter the response variable name, `TL_cm`, into the `lm()` (linear model) function for `response` and the explanatory variable name, `HW_cm`, for `explanatory` in line 21 to get the linear model output and value for the correlation coefficient.  Highlight and run lines 21--23.
