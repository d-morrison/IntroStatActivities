...
```{r, echo=TRUE}
cps <- read.csv("https://math.montana.edu/courses/s216/data/cps.csv") #This will read in the data set
```
...
9. A study was reported in which ninth grade Minnesota teens were asked whether they had gambled at least once a week in the past year.  The sample consisted of 49.1% male teens.  The proportion of male teens who had gambled at least once per week during the past year was 0.229, while among non-male teens this proportion was only 0.045. 
\vspace{1mm}
