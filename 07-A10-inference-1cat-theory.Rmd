...
```{r Normalcurve, fig.cap="Standard Normal Distribution", warning=FALSE, out.width="50%", echo = FALSE, fig.align='center'}
openintro::normTail()
``` 
...
```{r StandardNormal, fig.cap="Standard Normal Distribution", warning=FALSE, out.width="50%", echo = FALSE, fig.align='center'}
openintro::normTail()
```
