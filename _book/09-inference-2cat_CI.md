...
Using the `RScript` file for this activity, enter your answers for question 1 in place of the xx's to produce the bootstrap distribution with 1000 simulations, highlight and run lines 1 - 24.
