## Activity 4a:  IMDb Movie Reviews - Displaying One Quantitative Variable
...
To create a histogram of the IMDb scores, enter the variable name, `imdb_score` in the provided `R` script file for xx at line 20, highlight and run lines 1 - 24.  Visually, this shows us the range of IMDb scores for Movies released in 2016.
