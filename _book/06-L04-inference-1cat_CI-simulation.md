## Module 6 Lab:  Helper-Hinderer --- Simulation-based Confidence Interval
...
IF we assume ($H_0$ in context) ___________________________ ______________________________.
