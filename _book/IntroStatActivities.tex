...
\hypertarget{week-1---activity-1-martian-alphabet}{%
\section{Week 1 - Activity 1: Martian Alphabet}\label{week-1---activity-1-martian-alphabet}}
...
\hypertarget{week-3---activity-4-whats-the-probability}{%
\section{Week 3 - Activity 4: What's the probability?}\label{week-3---activity-4-whats-the-probability}}
...
\subsection{Week 3 Lab: Graphing Categorical Variables}\label{week-3-lab-graphing-categorical-variables}}
...
Download and open the provided \texttt{R} markdown file for Lab 2 to answer the following questions. Enter your group's names between the quotations for Author. In an \texttt{R} markdown file, you can click the \texttt{play} button on the upper right hand side of each code chunk to run that chunk of code.
...
If we wanted to know how many children in our data set were in each level of myopia, we would create a frequency bar plot of the variable \texttt{Sight}. Enter the variable name, \texttt{Sight}, for xx into the \texttt{ggplot} code below to create a bar plot. Click the play button to run this code chunk. Notice this is a \textbf{frequency} bar plot plotting counts (the number of children in each level of sight is displayed on the \(y\)-axis).
...
To examine the differences in level of myopia for the level of light, we would create a segmented bar plot of \texttt{Light} segmented by \texttt{Sight}. To create the segmented bar plot enter the variable name, \texttt{Light} (explanatory variable) for xx and the variable name, \texttt{Sight} (response variable) for yy in the code chunk below. Click the play button to run this code chunk.
...
We could also plot the data using a mosaic plot. Fill in the variable name, \texttt{Light} (explanatory variable) for xx and the variable name, \texttt{Sight} (response variable) for yy in the code chunk below. Click the play button to run this code chunk.
...
\hypertarget{week-5---activity-7-movie-profits}{%
\section{Week 5 - Activity 7: Movie Profits}\label{week-5---activity-7-movie-profits}}
...
\hypertarget{week-5---activity-8-movie-profits}{%
\section{Week 5 - Activity 8: Movie Profits}\label{week-5---activity-8-movie-profits}}
...
\hypertarget{week-4---lab-3-tip-percentages}{%
\section{Week 4 - Lab 3: Tip Percentages}\label{week-4---lab-3-tip-percentages}}
...
\textbf{Put in the labs???} 28. Write a paragraph summarizing the results as if you were writing a press release. Be sure to describe:
...
\hypertarget{week-8---lab-6-one-categorical-theory}{%
\section{Week 8 - Lab 6: One-categorical Theory}\label{week-8---lab-6-one-categorical-theory}}
...
\hypertarget{week-12---activity-17-covid-19-and-air-pollution}{%
\section{Week 12 - Activity 17: COVID-19 and Air Pollution}\label{week-12---activity-17-covid-19-and-air-pollution}}
...
\hypertarget{week-11---activity-17-construction-costs}{%
\section{Week 11 - Activity 17: Construction Costs}\label{week-11---activity-17-construction-costs}}
...
\hypertarget{week-12---lab-9-swearing}{%
\section{Week 12 - Lab 9: Swearing}\label{week-12---lab-9-swearing}}
...
\hypertarget{activity-homeless-housing-stability}{%
\section{Activity: Homeless Housing Stability}\label{activity-homeless-housing-stability}}
...
\hypertarget{inference-for-two-quantitative-variables-1}{%
\chapter{Inference for Two Quantitative Variables}\label{inference-for-two-quantitative-variables-1}}

\hypertarget{reading-guide-inference-for-slope-and-correlation-1}{%
\section{Reading Guide: Inference for Slope and Correlation}\label{reading-guide-inference-for-slope-and-correlation-1}}

\hypertarget{sections-7.1-and-7.2-inference-for-regression-and-model-conditions-1}{%
\subsection*{Sections 7.1 and 7.2 (Inference for regression and model conditions)}\label{sections-7.1-and-7.2-inference-for-regression-and-model-conditions-1}}
\addcontentsline{toc}{subsection}{Sections 7.1 and 7.2 (Inference for regression and model conditions)}
...
\hypertarget{formulas-12}{%
\subsubsection*{Formulas}\label{formulas-12}}
\addcontentsline{toc}{subsubsection}{Formulas}
...
\hypertarget{example-crop-yields-1}{%
\subsubsection*{Example: Crop yields}\label{example-crop-yields-1}}
\addcontentsline{toc}{subsubsection}{Example: Crop yields}
...
\hypertarget{example-midterm-elections-and-unemployment-1}{%
\subsubsection*{Example: Midterm elections and unemployment}\label{example-midterm-elections-and-unemployment-1}}
\addcontentsline{toc}{subsubsection}{Example: Midterm elections and unemployment}
...
\hypertarget{activity-moneyball-1}{%
\section{Activity: Moneyball}\label{activity-moneyball-1}}
...
\hypertarget{week-15---lab-11}{%
\section{Week 15 - Lab 11:}\label{week-15---lab-11}}
