...
\hypertarget{vocabulary-review.-complete-q1---3-before-attending-class.}{%
\subsection*{Vocabulary review. Complete Q1 - 3 before attending class.}\label{vocabulary-review.-complete-q1---3-before-attending-class.}}
\addcontentsline{toc}{subsection}{Vocabulary review. Complete Q1 - 3 before attending class.}
...
\section{Nightlight use and myopia}\label{nightlight-use-and-myopia}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myopia <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"https://math.montana.edu/courses/s216/data/ChildrenLightSight.csv"}\NormalTok{) }\CommentTok{#This will read in the data set}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{vocabulary-review.-complete-question-1---3-before-coming-to-class.}{%
\subsection*{Vocabulary review. Complete question 1 - 3 before coming to class.}\label{vocabulary-review.-complete-question-1---3-before-coming-to-class.}}
\addcontentsline{toc}{subsection}{Vocabulary review. Complete question 1 - 3 before coming to class.}
...
The \texttt{favstats} function from the \texttt{\textquotesingle{}mosaic} package gives the summary statistics for a quantitative variable. Here we have the summary statistics for the variable \texttt{imdb\_score}.
...
To create a histogram of the IMDb scores, enter the variable name, \texttt{imdb\_score} in the provided \texttt{RScript} file for xx, highlight and run the code lines 1 - 15. Visually, this shows us the range of IMDb scores for Movies released in 2016.
...
\tightlist
\item
  Using the histogram created, which range of IMDb scores have the highest frequency?
\end{enumerate}
...
\tightlist
\item
  Using the provided \texttt{RScript} file, we will create side-by-side histograms of IMDb by movie content rating. Enter the variable name, \texttt{imdb\_score} for yy and \texttt{content\_rating} for xx, highlight and run code lines 38 - 46.
\end{enumerate}
...
\tightlist
\item
  Using the provided favstats output and the side-by-side boxplots, interpret the value of the quartile 1 for the R content rating.
\end{enumerate}
...
\hypertarget{vocabulary-review.-complete-questions-1---4-before-coming-to-class.}{%
\subsection*{Vocabulary review. Complete questions 1 - 4 before coming to class.}\label{vocabulary-review.-complete-questions-1---4-before-coming-to-class.}}
\addcontentsline{toc}{subsection}{Vocabulary review. Complete questions 1 - 4 before coming to class.}
...
We will look at the relationship between `Budget' and `Revenue' for movies released in 2016. Enter the variable name \texttt{budget\_mil} for xx and \texttt{revenue\_mil} for yy to create the scatterplot. (Note: both variables are measures in ``millions of dollars''). Highlight and run lines 1 - 12.
...
\tightlist
\item
  Use the correlation, \(r\) found in question 6, to calculate the coefficient of determination between `Budget' and `Revenue', \(r^2\).
\end{enumerate}
...
What if we wanted to see if the relationship between `Budget' and `Revenue' differs if we add another variable into the picture? The following plot visualizes three variables, creating a \textbf{multivariate} plot.
...
\hypertarget{estimating-the-proportion-of-left-handedness-of-male-boxers}{%
\chapter{Estimating the Proportion of Left-Handedness of Male Boxers}\label{estimating-the-proportion-of-left-handedness-of-male-boxers}}
...
\hypertarget{activity-intro.-complete-q1---4-before-coming-to-class.}{%
\subsection*{Activity Intro. Complete Q1 - 4 before coming to class.}\label{activity-intro.-complete-q1---4-before-coming-to-class.}}
\addcontentsline{toc}{subsection}{Activity Intro. Complete Q1 - 4 before coming to class.}
