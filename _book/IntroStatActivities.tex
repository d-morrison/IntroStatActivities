...
To create a histogram of the IMDb scores, enter the variable name, \texttt{imdb\_score} in the provided \texttt{R} script file for xx at line 12, highlight and run lines 1--16. Notice that we are using the packages mosaic, ggplot2, and tidyverse for this activity. Visually, this histogram shows us the range of IMDb scores for Movies released in 2016.
