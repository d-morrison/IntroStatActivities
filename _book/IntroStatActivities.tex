...
\hypertarget{section-14.1-simulation-based-test-for-a-single-proportion}{%
\subsection*{Section 14.1 (Simulation-based test for a single proportion)}\label{section-14.1-simulation-based-test-for-a-single-proportion}}
\addcontentsline{toc}{subsection}{Section 14.1 (Simulation-based test for a single proportion)}
...
\hypertarget{section-14.2-bootstrap-for-a-single-proportion}{%
\subsection*{Section 14.2 (Bootstrap for a single proportion)}\label{section-14.2-bootstrap-for-a-single-proportion}}
\addcontentsline{toc}{subsection}{Section 14.2 (Bootstrap for a single proportion)}
