...
To examine the differences in level of myopia for the level of light, we would create a segmented bar plot of \texttt{Light} segmented by \texttt{Sight}. To create the segmented bar plot enter the variable name, \texttt{Light} for \texttt{explanatory} and the variable name, \texttt{Sight} for `response` in the 'R' script file in line 27. Highlight and run lines 26--33.
...
To create a histogram of the IMDb scores, enter the variable name, \texttt{imdb\_score} in the provided \texttt{R} script file for variable at line 20, highlight and run lines 19--24. Visually, this shows us the range of IMDb scores for Movies released in 2016.
...
\hypertarget{activity-7a-helperer-hinderer-simulation-test}{%
\section{Activity 7a: Helperer-Hinderer --- Simulation Test}\label{activity-7a-helperer-hinderer-simulation-test}}
...
\hypertarget{simualtion-methods}{%
\subsection{Simualtion Methods}\label{simualtion-methods}}
...
\tightlist
\item
  Report the simualtion 95\% confidence interval. Is this confidence interval similar to the confidence interval calculated in question 7?
\end{enumerate}
...
\textbf{10. Interpret the p-value in context of the problem.}
...
\setcounter{enumi}{2}
\item
  Calculate the conditional proportion of those who did not wearhelmets that had a head injury. Use appropriate notation with clear subscripts.
  \vspace{0.3in}
\item
...
\textbf{15. Would theory-based methods result in a similar p-value and confidence interval? Explain your reasoning.}
...
The response variable name is \texttt{Houseing\_Price} and the explanatory variable name is \texttt{Distance}.
