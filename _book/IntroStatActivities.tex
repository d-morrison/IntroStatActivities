...
\hypertarget{section-4.3-r-multiple-regression-and-section-4.4-chapter-4-review}{%
\subsection*{Section 4.3 (R: Multiple regression) and Section 4.4 (Chapter 4 Review)}\label{section-4.3-r-multiple-regression-and-section-4.4-chapter-4-review}}
\addcontentsline{toc}{subsection}{Section 4.3 (R: Multiple regression) and Section 4.4 (Chapter 4 Review)}
...
\item
  ...
  \rgs
\item
  The formula for the interval is \(\frac{34}{38}\pm (2×0.08) = 0.89 \pm 0.16\). Calculating that, you should get (0.73, 1.05). Why was the interval shown in the textbook (0.73, 1) instead of (0.73, 1.05)?
  \rgs
\item
