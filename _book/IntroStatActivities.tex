...
\begin{Highlighting}[]
    \KeywordTok{paired\_test}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ Air}\OperatorTok{$}\NormalTok{Difference,   }\CommentTok{\#Vector of differences or data set with column for each group}
            ...
            \DataTypeTok{as\_extreme\_as =}\NormalTok{ xxxx,  }\CommentTok{\#Observed statistic}
            \DataTypeTok{number\_repetitions =} \DecValTok{1000}\NormalTok{,  }\CommentTok{\#Number of draws for null distribution}
