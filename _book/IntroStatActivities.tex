...
\item
  When analyzing paired data, the summary statistic is the `mean difference' NOT the `difference in means'. This terminology will be \emph{very} important in interpretations.
\end{enumerate}
