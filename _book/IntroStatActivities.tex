...
\hypertarget{can-we-read-martian}{%
\section{Can we read ``Martian''?}\label{can-we-read-martian}}
...
\chapter{\texorpdfstring{Exploratory Data Analysis: \newline Categorical Variables}{Exploratory Data Analysis: Categorical Variables}}\label{exploratory-data-analysis-categorical-variables}}
...
\hypertarget{exploratory-data-analysis-regression-and-multivariate-thinking}{%
\chapter{Exploratory Data Analysis: Regression and Multivariate Thinking}\label{exploratory-data-analysis-regression-and-multivariate-thinking}}
...
\section{Record snowfall}\label{record-snowfall}}
