...
12.  Simulate a null distribution and compute the p-value. Using the `R` script file for this lab, enter your answers for question 10 in place of the `xx`'s to produce the null distribution with 1000 simulations.  Highlight and run lines 19--25.  
