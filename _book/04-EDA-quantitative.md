...
The box plot of movie budgets (in millions) by content rating is plotted using the code below.  Enter the variable `budget_mil` for yy and the variable `content_rating` for xx, highlight and run code lines 27 - 34. This plot helps to compare the budget for different levels of content rating.
...
For a little more practice using `Rstudio` to create graphs of quantitative variables we will look at some other variables in the Movies data set.  Download and open the provided `RScript` file and run the first 7 lines of code.
...
b. Which content rating has the highest center?

\vspace{0.2in}

c. Which variable is the explanatory variable? Response variable?
