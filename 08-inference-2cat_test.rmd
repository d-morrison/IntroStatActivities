...
We will use the pnorm function in `R` to find the p-value. Use the provided `RScript` file and enter the value of the standardized statistic found in question 18 at xx.
...
Using the `RScript` file for this activity, enter your answers for question 4 in place of the xx's to produce the null distribution with 1000 simulations.
