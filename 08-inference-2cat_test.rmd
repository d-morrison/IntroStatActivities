...
5. Calculate the conditional proportion of skiers/snowboarders that wore a helmet with a head injury.

\vspace{.6in}

6. Calculate the conditional proportion of skiers/snowboarders that did not wear a helmet with a head injury.
...
19.  Report the p-value from th `R` output.
\vspace{0.2in}
