...
\end{key}
 ...
 \item You should have several thousand blue dots and it should have
   ...
   interval estimate.
   \begin{enumerate}
   \item Click \fbox{80} and count:  How many red points would you
     guess are in the left tail?
\begin{key}
{\it  $N/10$}
\end{key}
     \\
...
\end{key}
  ...
  \item Predict: what will happen to the numbers in each tail for,
    say, a 90 \% interval, if we go from 5000 to 10000 resamples?
\begin{students}
  \vspace{.8cm}
\end{students}
