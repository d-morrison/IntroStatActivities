...
Upload and open the `R` script file for Week 11 lab. Upload and import the csv file, `pain_tolerance`. Enter the name of the data set (see the environment tab) for datasetname in the `R` script file in line 6. Highlight and run lines 1--7 to load the data and create a paired plot of the data. Y
