...
21. Where does the statistic (value from question 9) fall in the null distribution?  Is it towards the center or in one of the tails?  
...
23.  Using the simulation, what is the proportion of samples at the summary statistic or greater, if the true proportion of male boxers is 0.1? *Hint*: Look under the simulation.
...
29.  We already verified that the independence condition is satisfied in Q8 Is the success-failure condition met to model the data with the Normal distribution?
...
We will use the pnorm function in `R` to find the p-value. Use the provided R markdown file and enter the value of the standardized statistic calculated in Q31 at xx.
