...
Fill in the name of the explanatory variable and the response variable in lines **...** in the `R` script file to get the counts for each combination of levels of variables.
