...
We will look at the relationship between 'Budget' and 'Revenue' for movies released in 2016. Enter the variable name `budget_mil` for xx and `revenue_mil` for yy to create the scatterplot. (Note: both variables are measures in "millions of dollars").  
