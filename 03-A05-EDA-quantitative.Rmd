...
14.  Which content rating has the largest IQR?

\vspace{0.8in}

15.  Report the mean budget amount for the PG rating.

\vspace{0.3in}

16.  Report the mean budget amount for the R rating.

\vspace{0.3in}

17. Calculate the difference in mean budget amount for movies in 2016 with a PG rating minus those with a R rating.  Use appropriate notation.  Label group 1 as PG rating and group 2 as R rating.
...
18. Sketch the box plots created using the `R` code.

\vspace{1.5in}


19. Answer the following questions about the box plots created.
...
20. Which variable is the explanatory variable? Response variable?
